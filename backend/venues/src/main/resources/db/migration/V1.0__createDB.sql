...
alter table venues_rooms add constraint UK_6nij3xm1w5owfnviua0vp9186o unique (rooms_id);
alter table venues_rooms add constraint FKakytl1v8uduvp5117bji49ybya foreign key (rooms_id) references rooms;
alter table venues_rooms add constraint FK4fd2gm5xa0fwrvgpxwd7l3dslt foreign key (venues_id) references venues;
