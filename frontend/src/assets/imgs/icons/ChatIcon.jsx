...
export default function Chat(props) {
	return (
		<svg
			...
			y="0px"
			viewBox="0 0 473 473"
			style={{ enableBackground: 'new 0 0 473 473' }}
			xmlSpace="preserve"
			width="512px"
			height="512px"
			{...props}
			...
			<g>
				<g>
					<path
						...
						fill="#FFFFFF"
					/>
					<circle cx="236.381" cy="236.5" r="16.6" fill="#FFFFFF" />
					<circle cx="321.981" cy="236.5" r="16.6" fill="#FFFFFF" />
					<circle cx="150.781" cy="236.5" r="16.6" fill="#FFFFFF" />
				</g>
			</g>
			<g />
			<g />
